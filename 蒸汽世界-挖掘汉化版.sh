...
$GPTOKEYB "SteamWorldDig" -c ./Dig.gptk &
# pm_platform_helper skipped (not available)

$ESUDO env WRAPPED_LIBRARY_PATH="$GAMEDIR/libs.${DEVICE_ARCH}/":"$GAMEDIR/box86/native":"/usr/lib":"/usr/lib32" $weston_dir/westonwrap32.sh drm gl kiosk crusty_glx_gl4es \
...
$ESUDO systemctl start emulationstation 2>/dev/null || $ESUDO emulationstation &
